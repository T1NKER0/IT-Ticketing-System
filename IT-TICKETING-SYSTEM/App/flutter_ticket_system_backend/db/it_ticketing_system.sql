CREATE DATABASE  IF NOT EXISTS `it_ticketing_system` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `it_ticketing_system`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: it_ticketing_system
-- ------------------------------------------------------
...
--
-- Dumping data for table `initial_login`
--

LOCK TABLES `initial_login` WRITE;
/*!40000 ALTER TABLE `initial_login` DISABLE KEYS */;
/*!40000 ALTER TABLE `initial_login` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `ticket_assign` WRITE;
/*!40000 ALTER TABLE `ticket_assign` DISABLE KEYS */;
/*!40000 ALTER TABLE `ticket_assign` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-06-24 23:49:28
